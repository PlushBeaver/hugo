...
var (
	_ LanguageAnnouncer = (*realFilenameAndLangInfo)(nil)
)
...
func (f *realFilenameAndLangInfo) TranslationBaseName() string {
...
type realFileInfoPath struct {
	RealFilenameInfo
	path string
}

func (fi *realFileInfoPath) Path() string {
	return fi.path
}

type realFileInfoPathLang struct {
	*realFileInfoPath
	lang string
}

func (fi *realFileInfoPathLang) Lang() string {
	return fi.lang
}
